...
using WineStoreProject.Models;

namespace WineStoreProject.Controllers
{
    public class CatalogiesController : Controller
    {
        ...
        public ActionResult Edit([Bind(Include = "CatalogyID,CatalogyName,Description")] Catalogy catalogy)
        {
            ...
            {
                ViewBag.Error = "Có lỗi khi sửa ở bản ghi này!" + ex.Message;
                return View(catalogy);
            }
        }
        ...
        public ActionResult DeleteConfirmed(string id)
        {
            ...
            {
                ViewBag.Error = "Có lôi khi xóa bản ghi này!" + ex.Message;
